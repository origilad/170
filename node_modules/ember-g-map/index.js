...
module.exports = {
  ...
  contentFor: function(type, config) {
    ...
    if (type === 'head') {
      var src = '//maps.googleapis.com/maps/api/js?key=AIzaSyCBnH3016_e88Fae7ptUAK-EhUbyFBpMPk&callback=initMap';
      ...
      src += '?' + params.join('&');
      content = '<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCBnH3016_e88Fae7ptUAK-EhUbyFBpMPk&callback=initMap"type="text/javascript"></script>';
